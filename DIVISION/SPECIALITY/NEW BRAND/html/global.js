...
switch(pg_id){
		case 1:
		content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="background"><img src="slide1/1.png" width="1024" height="768"/></div><div class="circus_ring"><img src="slide1/2.png" width="392" height="322"/></div><div class="pouncing_cheetah"><img src="slide1/3.png" width="864" height="497"/></div>';
		break;
		case 2:
		content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/1.png" width="1024" height="768"/></div><div class="positionVideo"><video class="positionVideo" autoplay src="slide2/2.mp4" width="950" height="768"></video></div>';
		break;
		case 3:
		content='<link rel="stylesheet" type="text/css" href="slide3/slide3.css" media="screen"/><div class="background"><img src="slide3/1.png" width="1024" height="768"></div><div class="frame"><iframe src="slide3/Zimtus.pdf" style="width:1024px; height:768px;" scrolling="yes" frameborder="1"></iframe></div><div class="frameopen" onclick="framepop()"><img class="pdf_logo" src="slide3/2.png"/></div><div class="frameclose" onclick="frameclose()"><img src="slide3/3.png"/></div>';
		break;
		case 4:
		content='<link rel="stylesheet" type="text/css" href="slide4/slide4.css" media="screen"/><div class="background"><img src="slide4/1.png" width="1024" height="768"></div><div class="graph_enclosure"><div class="red_bar_graph"><img src="slide4/2.png" width="511" height="336"/></div><div class="blue_arc_1 arc_anim"><img src="slide4/3.png" width="117" height="100"/></div><div class="blue_arc_2 arc_anim"><img src="slide4/3.png" width="117" height="100"/></div><div class="blue_arc_3 arc_anim"><img src="slide4/3.png" width="117" height="100"/></div><div class="blue_bar_graph"><img src="slide4/4.png" width="511" height="201"/></div></div>';
		break;
}
